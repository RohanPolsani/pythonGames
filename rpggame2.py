...
class Player(Character):
  ...
  def quit(self):
    ...
    self.health = 0
  def help(self): print ("Here are all the commands. Quit: Player quits.    Status: You get the status of your Player.    Rest: Your Player rests.  Explore: Your Player explores.  Flee: Your Player flees away. Attack: Your Player attacks.")
